...
* 如果你喜欢我的这个博客模板，请在`L-hualong.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Marco Liu             # 你的博客网站标题
SEOTitle: Marco Liu			# 在后面会详细谈到
description: "Marco Liu"    # 随便说点，描述一下

# SNS settings      
github_username: Marco Liu     # 你的github账号
weibo_username: Marco Liu      # 你的微博账号，底部链接会自动更新的。
...
我的博客标题是 **“Marco Liu”** 但是我想要在搜索的时候显示 **“刘华龙的小窝 | Marco Liu”** ，这个就需要SEO Title来定义了。
