---
layout:     post
title:      "个人博客搭建  —— —— Jekyll+GithubPage+域名关联"
subtitle:   "Welcome to Marco Blog"
...
在秋招结束过后，已经刷过许许多多的笔试题和面试题的我，脑海中早已形成了一个自己的知识体系，再加上拿到offer的兴奋感，于是乎就有了开博客写技术总结和生活总结的冲动。一不做二不休，干脆花一天时间搞一个吧！
